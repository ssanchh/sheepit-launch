      ...
      <main className="max-w-4xl mx-auto px-6 py-12 flex-1">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-[#666666] leading-relaxed mb-3">The following types of products are prohibited:</p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">4. Voting and Community Participation</h2>
            
            <h3 className="text-xl font-medium text-[#2D2D2D] mb-3">4.1 Voting Rules</h3>
            ...
            <h3 className="text-xl font-medium text-[#2D2D2D] mb-3">4.2 Fair Play</h3>
            <p className="text-[#666666] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">5. Premium Services and Payments</h2>
            
            <h3 className="text-xl font-medium text-[#2D2D2D] mb-3">5.1 Premium Features</h3>
            <p className="text-[#666666] leading-relaxed mb-3">
            ...
            <h3 className="text-xl font-medium text-[#2D2D2D] mb-3">5.2 Refund Policy</h3>
            <p className="text-[#666666] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">6. Content Rights and Licenses</h2>
            
            <h3 className="text-xl font-medium text-[#2D2D2D] mb-3">6.1 Your Content</h3>
            <p className="text-[#666666] leading-relaxed mb-3">
            ...
            <h3 className="text-xl font-medium text-[#2D2D2D] mb-3">6.2 Our Content</h3>
            <p className="text-[#666666] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">7. Privacy</h2>
            <p className="text-[#666666] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">8. Disclaimers and Limitations of Liability</h2>
            
            <h3 className="text-xl font-medium text-[#2D2D2D] mb-3">8.1 Service Provided "As Is"</h3>
            <p className="text-[#666666] leading-relaxed mb-6">
              The Service is provided on an "as is" and "as available" basis without warranties of any kind, either express or implied. 
              We do not warrant that the Service will be uninterrupted, secure, or error-free.
            </p>

            <h3 className="text-xl font-medium text-[#2D2D2D] mb-3">8.2 Limitation of Liability</h3>
            <p className="text-[#666666] leading-relaxed mb-6">
            ...
            <h3 className="text-xl font-medium text-[#2D2D2D] mb-3">8.3 Third-Party Products</h3>
            <p className="text-[#666666] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">9. Indemnification</h2>
            <p className="text-[#666666] leading-relaxed mb-3">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">10. Termination</h2>
            <p className="text-[#666666] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">11. Governing Law and Disputes</h2>
            <p className="text-[#666666] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">12. Changes to Terms</h2>
            <p className="text-[#666666] leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">13. Contact Information</h2>
            <p className="text-[#666666] leading-relaxed mb-4">
